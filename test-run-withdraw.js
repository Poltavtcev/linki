    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, (0, withdraw_1.withdrawOldInvitations)(page, ACCOUNT_ID, 0, "test-runner")];
                case 3:
                    count = _a.sent();
                    console.log("TEST SUCCESS: Withdrawn ".concat(count, " invitations."));
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
