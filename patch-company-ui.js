...
// 2. Add state variables inside default export function CompanyDetail(props)
code = code.replace(
  /export default function CompanyDetail\(\{ company: initialCompany \}: Props\) \{/,
  `export default function CompanyDetail({ company: initialCompany }: Props) {
...
code = code.replace(
  ...
  `
      {/* Add Contact Modal */}
      {showAddContact && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-base-100/80 backdrop-blur-sm">
