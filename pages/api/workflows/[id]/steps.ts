...
export default function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  if (req.method === "POST") {
    ...
    const track: "linkedin" | "email" | "integration" = trackIn === "integration" || step_type === "integration" || step_type === "change_status" ? "integration" : trackIn === "email" || step_type === "email" ? "email" : "linkedin";
